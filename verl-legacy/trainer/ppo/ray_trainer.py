            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("gen", timing_raw, color="red"):
                        if not self.async_rollout_mode:
                            '''
                                Perplex TODO: Make the generation sequence to use LLM
                                wg here mean worker group
                            '''
                            # HERE is the part where put prompt into search and generate
                            gen_batch_output = self.actor_rollout_wg.generate_sequences(gen_batch)

                            # print the text of gen batch output
                        else:
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if reward_extra_infos_dict:
                            ...
                            # metrics.update({
                            #     "critic/rewards/reward_1": reward_extra_infos_dict['reward_1'],
                            #     "critic/rewards/reward_2": reward_extra_infos_dict['reward_2']
                            # })
