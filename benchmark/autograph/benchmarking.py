    ...
    for kg_name in kg_names:
        ...
        for qa_name in qa_names:
            ...
            benchmark_config = BenchMarkConfig(
                ...
                question_file=f"/home/httsangaj/projects/AutoSchemaKG/benchmark_data/{qa_name}.json",
                result_dir=f"{base_dir}/benchmark",
                include_concept=False,
                include_events=False,
            ...
            logger = setup_logger(benchmark_config, 
                                  log_path = f"{base_dir}/benchmark/{qa_name}_{time.time()}_benchmark.log")
            if args.use_upperbound:
            ...
            if args.use_dense_only:
                ...
                # passage_retriever = SimpleTextRetriever(
                #     passage_dict=data["text_dict"],
                #     sentence_encoder=sentence_encoder,
                #     data=data,
                #     inference_config=inference_config,
                ...
                # Start benchmarking
                benchmark = RAGBenchmark(config=benchmark_config, logger=logger)
                benchmark.run([tog_retriever, graph_retriever], 
                            llm_generator=llm_generator)
