...
echo "Container: /project/awskgraph/VeRL/verl.sqsh"
srun --container-writable \
    ...
    bash -c "source /root/miniconda3/etc/profile.d/conda.sh && conda activate verl && pip list && cd /workspace/autograph-r1 && python autograph-r1/test/test_slurm.py"
