...
TRAIN_DATA="$PROJECT_DIR/autograph-r1/data/musique_train_distract_False.parquet"
VAL_DATA="$PROJECT_DIR/autograph-r1/data/musique_validation_distract_False.parquet"

TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
CHECKPOINT_DIR="/project/awskgraph/autograph/checkpoints/${TIMESTAMP}_qwen2.5-7b-autograph"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='test_superpod-qwen2.5-7b-auto-graph-rl' \
    ...
    +actor_rollout_ref.rollout.api_domain='rag_server' \
